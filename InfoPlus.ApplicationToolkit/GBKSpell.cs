...
namespace InfoPlus.ApplicationToolkit
{
    public class GBKSpell
    {
        ...
        {
            return ToPinYin(txt, string.Empty);
        }

        public static string GetAcronymes(string txt, out string fullSpell)
        {
            fullSpell = string.Empty;
            string acronymes = string.Empty;
            if (null != txt)
            {
                foreach (char c in txt)
                {
                    string spell = ToPinYin(c.ToString());
                    fullSpell += spell;
                    if (spell.Length > 0)
                        acronymes += spell[0];
        ...
        public static string ToPinYin(string txt, string spliter)
        {
            txt = txt.Trim();
                ...
                else
                {
                    ...
                    if (!CodeCollections.ContainsKey(charCode))
                    {
                        for (int i = charCode; i <= 0; --i)
                        {
                            ...
                            {
                                result.Append(spliter + CodeCollections[i] + spliter);
                                break;
                            }
                        }
                    }
                    ...
                    {
                        result.Append(spliter + CodeCollections[charCode] + spliter);
                    }
                }
            }
